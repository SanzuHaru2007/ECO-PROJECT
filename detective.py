...
def register_detective_handlers(dp):
    ...
    async def delo1_option1(callback: CallbackQuery):
        ...
        text = (
            "🇷🇺 **Россия**\n\n"
            "Делегация РФ публично поддерживает «углеродную нейтральность к 2060», но внутри кулуаров настаивает на сохранении субсидий для «северных территорий».\n\n"
        )
    ...
    async def delo1_option2(callback: CallbackQuery):
        ...
        text = (
            "🇸🇦 **Саудовская Аравия**\n\n"
            "Королевство официально объявило о «Саудовской зелёной инициативе», но именно его представитель на прошлой неделе встречался с лоббистами Exxon...\n\n"
    ...
    async def choose_delo2_option2(callback: CallbackQuery):
        ...
        text = (
            "❌ **НЕВЕРНО**\n\n"
            "Правительство Нигерии — не главный виновник. Оно коррумпировано, но основная ответственность лежит на другом. \n\n"
            "**Попробуй ещё раз!**"
        )
    ...
    async def choose_delo2_option3(callback: CallbackQuery):
        ...
        text = (
            "❌ **НЕВЕРНО**\n\n"
            "Боевики — это следствие проблемы, а не её причина. Основной источник загрязнения остался в тени. \n\n"
            "**Попробуй ещё раз!**"
        )
        await callback.message.answer(text, reply_markup=retry_delo2)
    ...
    async def delo3_option1(callback: CallbackQuery):
        ...
        text = (
            "🌴 **Местные фермеры**\n\n"
            "Миллионы индонезийских крестьян выжигают леса, чтобы посадить пальмы на своих участках. Они не думают об экологии — им нужно прокормить семьи. Но они ли являются главными виновниками? \n\n"
    ...
    async def choose_delo3_option1(callback: CallbackQuery):
        ...
        text = (
            "❌ **НЕВЕРНО**\n\n"
            "Фермеры — лишь мелкие игроки. 80% вырубки приходится на крупные плантации.\n\n"
            "**Попробуй ещё раз!**"
        )
    ...
    async def choose_delo3_option2(callback: CallbackQuery):
        ...
        text = (
            "❌ **НЕВЕРНО**\n\n"
            "Корпорации — соучастники, но главный преступник остается в тени.\n\n"
            "**Попробуй ещё раз!**"
        )
        await callback.message.answer(text, reply_markup=retry_delo3)
